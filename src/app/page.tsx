...
// Removed the import for sendEmail from "@/app/actions/sendEmail"
// since we'll define it below.
          ...
          <div className="flex-1 p-4 md:p-6 mx-auto w-full mb:max-w-4xl md:max-full md:px-[140px]">
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm">
                {/* ...rest of the logic and JSX remain unchanged... */}
              </div>

              {/* Vehicle Section, Receipt Section, Payment Section as before */}
            </div>
          </div>
          {showErrorScreen && (
